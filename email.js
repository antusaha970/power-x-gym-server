const emailBody = (name, plan, payment) => {
  return `
  <html>
    <body>
      <h1>Dear ${name},</h1>
      ...
      <p>I wanted to remind you that you have selected <strong>${plan}</strong>  and your first class is scheduled on <strong>Sunday</strong>. ${
    !payment
      ? "Please remember to bring your payment for the first class when you come in."
      : "Thank you for pay in Advanced"
  }</p>
